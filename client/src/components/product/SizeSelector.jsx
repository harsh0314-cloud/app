export default function SizeSelector({ sizes = [], selected, onSelect }) {
  return (
    <div className="mt-3" data-testid="size-selector">
        ...
        {sizes.map((s) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-w-[3.25rem] flex-col items-center rounded-xl border px-4 py-3 text-sm font-semibold transition-all duration-200
